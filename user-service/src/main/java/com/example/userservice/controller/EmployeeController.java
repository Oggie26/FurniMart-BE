...
public class EmployeeController {
        ...
        public ApiResponse<UserResponse> updateEmployee(@PathVariable String id,
        ...
        @PreAuthorize("hasRole('ADMIN')")
        public ApiResponse<UserResponse> updateEmployeeRole(@PathVariable String id,
        ...
        public ApiResponse<PageResponse<UserResponse>> getManagersWithPagination(
                ...
                return ApiResponse.<PageResponse<UserResponse>>builder()
                                ...
                                .data(employeeService.getEmployeesByRoleWithPagination(EnumRole.BRANCH_MANAGER, page,
                                                size))
                                .build();
        }
