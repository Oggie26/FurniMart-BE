...
public enum ErrorCode {
    ...
    ASSIGNMENT_ALREADY_EXISTS(1231, "Đơn hàng đã được phân công. Mã phân công: {0}, Trạng thái: {1}", HttpStatus.BAD_REQUEST),
    INVOICE_ALREADY_GENERATED(1232, "Hóa đơn đã được tạo cho đơn hàng này. Mã phân công: {0}", HttpStatus.BAD_REQUEST),
    PRODUCTS_ALREADY_PREPARED(1233, "Sản phẩm đã hoàn tất chuẩn bị cho đơn hàng này. Mã phân công: {0}", HttpStatus.BAD_REQUEST),
    INSUFFICIENT_STOCK(1234, "Số lượng tồn kho không đủ", HttpStatus.BAD_REQUEST),
    PRODUCTS_NOT_PREPARED(1240, "Sản phẩm chưa sẵn sàng. Vui lòng chuẩn bị sản phẩm trước khi phân công", HttpStatus.BAD_REQUEST),
    INVOICE_NOT_GENERATED(1241, "Hóa đơn chưa được tạo hoặc chưa được duyệt. Mã phân công: {0}", HttpStatus.BAD_REQUEST),
    ASSIGNMENT_NOT_READY(1242, "Đơn phân công chưa sẵn sàng. Trạng thái hiện tại: {0}, yêu cầu: READY. Mã phân công: {1}", HttpStatus.BAD_REQUEST),
