...
public enum ErrorCode {
    ...
    PRODUCTS_NOT_PREPARED(1240, "Products chưa được chuẩn bị. Assignment ID: {0}", HttpStatus.BAD_REQUEST),
    INVOICE_NOT_GENERATED(1241, "Invoice chưa được tạo/duyệt. Assignment ID: {0}", HttpStatus.BAD_REQUEST),
    ASSIGNMENT_NOT_READY(1242, "Assignment chưa sẵn sàng để phân công. Status hiện tại: {0}, cần: READY. Assignment ID: {1}", HttpStatus.BAD_REQUEST),
